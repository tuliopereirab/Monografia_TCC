...
\begin{figure}[htp]
\centering
\includegraphics[scale=0.6]{images/conversor/img_conv_line.jpg}
...
\begin{figure}[htp]
\centering
\includegraphics[scale=0.5]{images/conversor/img_conv_mif.jpg}
...
\begin{figure}[htp]
\centering
\includegraphics[scale=0.5]{images/conversor/img_conv_arq_texto.jpg}
...
-12             & \textbf{SAÍDA: Um ou mais erros foram encontrados no simulador. Instrução não executada.}                                                                                         \\ \hline
