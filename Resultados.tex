...
Já a versão atual, organizada e com maior leque de instruções suportadas, teve leve queda dessa frequência, possuindo, atualmente, 84,35 MHz. Com esse valor, é possível definir, através da equação \ref{eq_periodo}, um período de \clock{} de 11,85 nanosegundos (ns).
