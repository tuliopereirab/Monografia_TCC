...
Nos dias atuais, existe uma grande atenção voltada para o consumo energético de todos os sistemas que necessitam de energia. Então, para todos os projetos a serem desenvolvidos futuramente, é esperado que um dos objetivos principais seja obter grande poder computacional utilizando-se menor energia.
...
Conforme mostra a Figura \ref{img_result_energia}, a energia térmica total dissipada foi de 132,56 miliwatts (mW). Esse valor é a soma das energias dinâmica (30,07 mW), estática (81,20 mW) e dos pinos de entrada (21,28 mW). A diferença entre os dois é, basicamente, que a energia dinâmica indica a dissipação quando os transistores estão em funcionamento (estado \textit{"on"}), enquanto a estática indica que eles estão desligados (estado \textit{"off"}).
...
\begin{figure}[htp]
\centering
\includegraphics[scale=0.6]{images/resultados/Simulacoes/pizza_teste1.png}
...
\begin{figure}[htp]
\centering
\includegraphics[scale=0.6]{images/resultados/Simulacoes/pizza_teste2.png}
...
\begin{figure}[htp]
\centering
\includegraphics[scale=0.6]{images/resultados/Simulacoes/pizza_teste3.png}
...
\begin{figure}[htp]
\centering
\includegraphics[scale=0.6]{images/resultados/Simulacoes/pizza_teste4.png}
