...
As future projects, it is able to implement new modules able to increase the number of functionalities and instructions supported by the architecture. However, it is necessary to keep acceptable the architecture features. Currently, it has as maximum operational frequency 84.35 MHz, area with 728 logical elements and energy dissipation of \textbf{DADOS DE ENERGIA}.
}
\end{englishabstract}
