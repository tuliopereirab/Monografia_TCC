...
\banca[Prof.~Dr.]{Pinho}{Leonardo Bidese de}       % membro da banca de defesa 
...
\begin{dedicatoria}
Dedico este trabalho, primeiramente, aos meus pais, que sempre me deram total apoio e me deram a oportunidade de realizar este curso. Dedico também aos meus tios e irmãos, que sempre estiveram comigo e me ajudaram em ajudaram durante esta trajetória.
\end{dedicatoria}
...
As future projects, it is able to implement new modules able to increase the number of functionalities and instructions supported by the architecture. However, it is necessary to keep acceptable the architecture features. Currently, it has as maximum operational frequency 84.35 MHz, area with 728 logical elements and energy dissipation of 132,56 mW.
}
\end{englishabstract}
