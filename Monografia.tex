...
This document presents a strategy of a processor implementation, created in VHDL, able to execute algorithms written in Python, and, in the future, a directly connection with the native Python compiler. 
