...
Cada máquina de estados começa sempre em um estado inicial, o qual será o ponto de partida para cada uma das máquinas de estado parciais, que são como podem ser chamadas as máquinas de estados responsáveis por funcionalidades específicas (instruções ou classes de instruções, como no caso das instruções BINARY\_). Nesse estado, é esperado que haja uma definição de instrução a ser executada ou um carregamento de dados iniciais necessários, para que se possa, então, encaminhar o sistema para a máquina de estado parcial responsável pela funcionalidade que será executada. 
